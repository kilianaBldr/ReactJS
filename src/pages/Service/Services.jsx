                ...
                <div className="container  pt-4 pb-5 mt-5">
                    <div className="row g-3">
                        <div className="col-md-4 col-lg-4">
                            ...
                            <i className="fa-solid uxdI fa-desktop fa-2xl p-5"style={{ color:"#0d6efd"}}></i>
                        ...
                        <div className="col-md-4 col-lg-4">
                            ...
                            <i class="fa-solid uxdI fa-file-code fa-2xl p-5 "style={{ color:"#0d6efd"}}></i>
                        ...
                        <div className="col-md-4 col-lg-4">
                            <div className="card uxd text-center mb-1 p-4">
                            <i class="fa-solid uxdI fa-magnifying-glass-dollar fa-2xl p-5" style={{ color:"#0d6efd"}}></i>
